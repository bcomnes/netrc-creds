...
var os = require("os");
var machine = core.getInput("machine");
if (machine)
  assert(typeof machine === "string", "machine input must be a string");
var login = core.getInput("login");
if (login)
  assert(typeof login === "string", "login input must be a string");
var password = core.getInput("password");
if (password)
  assert(typeof password === "string", "password input must be a string");
var credsInput = core.getInput("creds");
...
var netrc = path.resolve(os.homedir(), ".netrc");
exec(`touch ${netrc}`, (error, stdout, stderr) => {
  ...
  exec(`chmod 600 ${netrc}`, (error2, stdout2, stderr2) => {
    console.log(stdout2);
